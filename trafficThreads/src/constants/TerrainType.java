...
public enum TerrainType {
    ...
    INTERSECTION_UP(5, "double_arrow_up.png", Arrays.asList("UP")),
    INTERSECTION_RIGHT(6, "double_arrow_right.png", Arrays.asList("RIGHT")),
    INTERSECTION_DOWN(7, "double_arrow_down.png", Arrays.asList("DOWN")),
    INTERSECTION_LEFT(8, "double_arrow_left.png", Arrays.asList("LEFT")),
